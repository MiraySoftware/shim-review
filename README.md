...
* Fix build error in mok.c
    ...
    (Patch was merged in shim-15.1 branch)
...
https://github.com/MiraySoftware/build_shim_miray/tree/master and use the 
'build_shim' script
When run the script will check out the miray-15.1 repository into a subdirectory,
